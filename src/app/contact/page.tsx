      ...
      <div className="container mx-auto py-16 pt-32 md:py-32 px-4">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center xl:items-start gap-8">
          ...
          >
            ...
            <p className="mb-4">
              <span className="font-semibold">Email:</span> muhammadhassan202005@gmail.com
            </p>
            <p className="mb-4">
              <span className="font-semibold">Phone:</span> 0314 2721223
            </p>
            <p className="mb-4">
              <span className="font-semibold">Address:</span> 123 Street Name, City, Country
            </p>
            <p className="text-sm hidden lg:block">
              Reach out me for any queries or further information. I'm here to help!
            </p>
          </motion.div>
